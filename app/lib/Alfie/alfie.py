...
def preamble(): # This is the preamle
    ...
    latex = latex + "\\setmainfont[BoldFont=Source Sans Pro, ItalicFont=Source Sans Pro Light Italic, BoldItalicFont=Source Sans Pro Semibold, SlantedFont=Source Sans Pro Bold, SmallCapsFont =Source Sans Pro Light, SmallCapsFeatures={LetterSpace=1.15, Letters=SmallCaps}, Numbers={OldStyle, Proportional}, Scale=0.75 ] {Source Sans Pro Light}\n"
